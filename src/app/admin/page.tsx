    ...
    <section className="space-y-8">
      <div>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-muted">
          Manage the prayer tune library and prepare published playlists from
          this area.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-lg border border-foreground/10 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-muted">
            Audio upload and tune management will be added in a later task.
          </p>
        </div>
        <div className="rounded-lg border border-foreground/10 bg-white p-5 shadow-sm">
          <h3 className="text-base font-semibold">Playlists</h3>
          <p className="mt-2 text-sm leading-6 text-muted">
            Playlist assembly and publishing will be added in a later task.
          </p>
        </div>
      </div>
    </section>
