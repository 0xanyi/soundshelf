...
describe("serializePublicPlaylistSummary", () => {
  it("counts every tune in the playlist", () => {
    expect(
      serializePublicPlaylistSummary({
        id: "playlist_1",
        title: "Morning",
        ...
        items: [
          { tune: { durationSeconds: 120 } },
          { tune: { durationSeconds: 80 } },
...
describe("serializePublicPlaylistDetail", () => {
  it("returns ordered tracks with signed urls and no raw object keys", async () => {
